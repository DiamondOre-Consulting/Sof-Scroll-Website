  ...
  return (
    <div>
      <div className="py-10">
        ...
        <div className="grid grid-cols-4 mx-auto mt-20 px-10">
        <div class="w-80 bg-white shadow border hover:border-dark hover:border-2 rounded">
          <div
            class="h-52 w-full bg-gray-200 flex flex-col justify-between p-4 bg-cover bg-center"
            style={{
              backgroundImage:
                `url('${tissue1}')`,
            }}
          ...
          <div class="p-4 flex flex-col items-center">
            ...
            <button class="py-2 px-4 bg-dark text-white rounded hover:bg-blue-600 active:bg-blue-700 disabled:opacity-50 mt-4 w-full flex items-center justify-center">
              Add to order
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 ml-2"
