...
>
  <p
    style={{
      ...
      lineHeight: "1.2", // Ensure a fixed line height
    }}
    className="text-base sm:text-[2.5rem] py-10 font-bold text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300"
  >
    {revealText}
  </p>
</motion.div>
