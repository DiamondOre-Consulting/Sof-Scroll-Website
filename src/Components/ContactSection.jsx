...
const ContactSection = ({ contact }) => {
    ...
    return (
        <div className='w-full'>
            <div className={`flex flex-wrap items-center justify-around w-full gap-8  bg-slate-50 ${contact ? 'sm:py-20 py-12' : 'py-6 sm:py-8'}`}>
                {/* Left Column */}
                <div className="max-w-[34rem] px-4 md:max-w-[35rem] flex items-center">
                    <div className="">
                        ...
                        <p className='sora-400 leading-[1.85rem] text-[#535760] mb-8'>
                            We are committed to delivering the highest quality tissue products, with a focus on customer satisfaction through innovation and excellence at every stage of our manufacturing process. Our dedication to sustainability and responsible sourcing is woven into each product, benefiting both our customers and the environment.
                        </p>
                ...
                <div className="max-w-[34rem] sm:p-12 p-6 bg-white shadow-sm rounded-xl  md:max-w-[31rem] mt-10 lg:mt-0" data-aos="fade-up" data-aos-duration="600">
                    <h3 className="mb-4 text-2xl text-dark sora-600">GET IN TOUCH WITH US</h3>
