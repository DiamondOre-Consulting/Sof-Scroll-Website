          ...
          {cart.length === 0 ?
            ...
            <div className="bottom-0 flex flex-wrap items-center justify-between w-full gap-4 p-1 mt-4 border rounded-md shadow-md h-fit lg:mt-0  border-[#d2ceb2] max-w-[40rem] lg:max-w-[35rem] mx-auto">
              ...
              <div className="flex flex-wrap items-center justify-center w-full bg-white rounded lg:items-start lg:gap-4 lg:flex-col">
                  ...
                  {cart?.map((item, index) => (
                    <div className="relative p-4 py-1 pt-3 space-y-2 overflow-hidden border rounded-md bg-gray-50" key={item?.itemCode}>
                      ...
                      <div className="relative flex flex-wrap items-center justify-between gap-2 p-3 py-1 bg-white border rounded-md shadow-sm" >
                        ...
                        <p className="flex items-center gap-2 font-medium text-gray-700"> <div className="flex items-center overflow-hidden border border-gray-400 rounded shadow">
                          <button
                ...
                <button onClick={handleOrder} className="w-full p-2 m-1 mt-2 font-semibold text-white bg-blue-500 rounded cursor-pointer sm:mt-1 ">Quote me!</button>
              </div>
