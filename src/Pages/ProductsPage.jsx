...
const ProductPreviews = ({ previews }) => {
  ...
  return (
    <div className="p-4 bg-gray-100 dark:bg-slate-800 rounded-xl sm:p-6 lg:p-12 lg:mr-6">
      <Helmet>
        <title>Shop Premium Tissue & Makhana Products | SOF SSCRROL</title>
        <meta
          name="description"
          content="Browse the full range of SOF SSCRROL's high-quality products including hygienic tissue rolls, facial tissues, hospital sheets, and roasted Makhana snacks under Nuts Magic."
        />
      </Helmet>
          ...
          <div className="w-full lg:w-1/2">
            <div className="mb-6 lg:mb-12">
              ...
              <p className="mb-6 opacity-70">
                <span>4.0</span> <FaStar className="mx-2 text-yellow-500" />
